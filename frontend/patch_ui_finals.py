...
# And if there is ANY object rendering, we add json pipe just in case to avoid crash, but wait, number pipe fails gracefully sometimes.
# I'll just write it as is.
