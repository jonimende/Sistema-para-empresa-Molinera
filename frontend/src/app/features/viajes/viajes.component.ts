            ...
            <div class="flex gap-6 h-[calc(100vh-12rem)]">
              ...
              <div class="w-2/3 bg-white rounded-xl border border-slate-200 shadow-sm overflow-y-auto">
                ...
                <form *ngIf="isCreatingCombustible || selectedCombustibleId" [formGroup]="combustibleForm" class="p-6 space-y-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-5 rounded-xl border border-slate-100">
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Camión</label>
                      <select formControlName="patente_chasis" class="w-full border-slate-200 rounded-lg shadow-sm py-2 px-3 focus:ring-indigo-500 font-bold text-indigo-700 font-mono">
                    ...
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Litros de Gasoil</label>
                      <input type="number" step="0.1" formControlName="litros_gasoil" placeholder="Ej: 150.5" class="w-full border-slate-200 rounded-lg shadow-sm py-2 px-3 focus:ring-indigo-500 font-bold">
                    </div>
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Kilometraje</label>
                      <input type="number" formControlName="kilometraje" placeholder="Ej: 125000" class="w-full border-slate-200 rounded-lg shadow-sm py-2 px-3 focus:ring-indigo-500">
                    </div>
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Consumo L/100km</label>
                      <input type="number" formControlName="consumo" class="w-full border-slate-200 rounded-lg shadow-sm py-2 px-3 bg-indigo-50 text-indigo-700 font-bold" readonly>
                    </div>
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Foto Tablero</label>
                      <input type="file" (change)="onFileSelected($event)" accept="image/*" class="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                    </div>
                  </div>
            ...
            <div class="flex gap-6 h-[calc(100vh-12rem)]">
              ...
              <div class="w-2/3 bg-white rounded-xl border border-slate-200 shadow-sm overflow-y-auto">
                ...
                <form *ngIf="isCreatingCamion || selectedCamionId" [formGroup]="camionForm" class="p-6 space-y-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-5 rounded-xl border border-slate-100">
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Patente Chasis</label>
                      <input type="text" formControlName="patente_chasis" placeholder="Ej: AB123CD" class="w-full border-slate-200 rounded-lg shadow-sm py-2.5 px-3 focus:ring-indigo-500 font-mono font-bold text-lg">
                    </div>
                    <div>
                      <label class="block text-sm font-bold text-slate-700 mb-1">Chofer Asignado</label>
                      <select formControlName="chofer_asignado" (change)="onChoferChange($event)" class="w-full border-slate-200 rounded-lg shadow-sm py-2.5 px-3 focus:ring-indigo-500 font-bold text-indigo-700">
                        <option value="" disabled selected>Seleccione Chofer...</option>
